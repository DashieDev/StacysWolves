package stacywolves.common.menu;
...
public class CraftingWolfMenu extends RecipeBookMenu<CraftingContainer> {
   ...
   private static final int MAX_CRAFTING_DISTANCE_SQR = 25;

   private final CraftingContainer craftSlots = new CraftingContainer(this, 3, 3);
   private final ResultContainer resultSlots = new ResultContainer();
   private final ContainerLevelAccess access;
   private final Player player;
   private final CraftingTableWolf wolf;

   public CraftingWolfMenu(CraftingTableWolf wolf, int p_39353_, Inventory p_39354_) {
      this(wolf, p_39353_, p_39354_, ContainerLevelAccess.NULL);
   }

   public CraftingWolfMenu(CraftingTableWolf wolf, int p_39356_, Inventory p_39357_, ContainerLevelAccess p_39358_) {
      super(StacyWolvesMenuTypes.CRAFTING_WOLF_MENU.get(), p_39356_);
      this.wolf = wolf;
   ...
   public boolean stillValid(Player player) {
      return wolf.isAlive() && player.distanceToSqr(wolf) <= MAX_CRAFTING_DISTANCE_SQR;
  }
