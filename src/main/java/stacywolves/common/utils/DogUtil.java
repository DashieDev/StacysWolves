...
public class DogUtil {
     ...
     */
    public static boolean searchAndTeleportToOwner(BaseWolf dog, int radius) {
     ...
     */
    public static BlockPos chooseSafePosNearOwner(BaseWolf dog, int radius) {
        ...
        BlockPos finaltp = safeblockposes.get(dog.getRandom().nextIntBetweenInclusive(0, safeblockposes.size() - 1));
        return finaltp;
    }
     ...
     */
    public static boolean guessAndTryToTeleportToOwner(BaseWolf dog, int radius) {
        var owner_b0 = dog.getOwner().blockPosition();
     ...
     */
    public static boolean wantToTeleportToThePosition(BaseWolf dog, BlockPos pos) {
        var owner_b0 = dog.getOwner().blockPosition();
        boolean flag = 
     ...
     */
    public static boolean posWillCollideWithOwnerMovingForward(BaseWolf dog, BlockPos pos) {
     ...
     */
    public static boolean hasLineOfSightToOwnerAtPos(BaseWolf dog, BlockPos pos) {
    ...
    public static boolean isTeleportSafeBlock(BaseWolf dog, BlockPos pos, boolean teleportToLeaves) {
     ...
     * 
     */
    public static boolean canPathReachTargetBlock(BaseWolf dog, @Nonnull Path path, BlockPos pos, int dY) {
     ...
     * @param dog
     */
    public static boolean mayGetPushedIntoHazard(BaseWolf dog, Vec3 pushVec) {
     ...
     */
    public static void moveToIfReachOrElse(BaseWolf dog, BlockPos pos, double speedModifier, 
        int dY, Consumer<BaseWolf> orElse) {
    ...
    private static void teleportInternal(BaseWolf dog, BlockPos target) {
        dog.fallDistance = 0;
