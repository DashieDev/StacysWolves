package stacywolves.client.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class BaseWolfModel<T extends BaseWolf> extends ColorableAgeableListModel<T> {
   ...
   public BaseWolfModel(ModelPart p_171087_) {
