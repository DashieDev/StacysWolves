...
@OnlyIn(Dist.CLIENT)
public class CraftingWolfScreen extends AbstractContainerScreen<CraftingWolfMenu> implements RecipeUpdateListener {
   private static final ResourceLocation CRAFTING_TABLE_LOCATION = new ResourceLocation("textures/gui/container/crafting_table.png");
   private static final ResourceLocation RECIPE_BUTTON_LOCATION = new ResourceLocation("textures/gui/recipe_button.png");
   private final RecipeBookComponent recipeBookComponent = new RecipeBookComponent();
   private boolean widthTooNarrow;

   public CraftingWolfScreen(CraftingWolfMenu p_98448_, Inventory p_98449_, Component p_98450_) {
